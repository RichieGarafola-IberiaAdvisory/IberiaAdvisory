...
st.title("Welcome to Iberia Advisory's Home")
st.markdown("This is the home for Iberia Advisory's proprietary tools for automating tasks.")

# Introduction
st.write("Welcome to Iberia Advisory's Home, the central hub for our exclusive tools designed to automate various processes. Explore the following sections to access our suite of powerful automation tools:")
...
# Footer
st.write("If you have any questions or need assistance, please feel free to contact Richie: [RGarafola@IberiaAdvisory.com](mailto:RGarafola@IberiaAdvisory.com)")
